...
/**
 * Created by dharmawan on 12/7/17.
 */
...
public class SaveFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_save_,container,false);
        rv = rootView.findViewById(R.id.rv_save);
        refresher = rootView.findViewById(R.id.save_refresh);
    ...
    private void fetchData(String response){
        ...
        if(msg.equals("OK") || msg.equals("EMPTY")){
            ...
            SaveAdapter saveAdapter = new SaveAdapter(getContext(),listData);
            rv.setAdapter(saveAdapter);
